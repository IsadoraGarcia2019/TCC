  ...
  <div class="row">
    <div class="shadow " style="  background-color: #f2392c ;background-image: url('media/images/food-pattern.png');min-height: 100px; min-width: 100%; background-size: 30%; background-position: center 1050px;">
      <div class="text-center my-5">
        <h1 class="text-white mb-5">Cadastrar um endereço</h1>
      </div> 
    </div>
  </div>
    ...
    <div class="card shadow" style="margin-right: auto; margin-left: auto;">
      <div class="card-body" > 
        ...
        <form method="post" action="">
          <h2 class="mb-3"><strong>Novo Endereço</strong></h2>
          <div class="form-row">
            <div class="form-group col-md-12">
              <label for="local"><strong>Nome do local</strong></label>
              <input type="text" class="form-control" id="local" name="local" placeholder="Ex: casa">
          ...
          <div class="form-row">
            <div class="form-group col-6">
              ...
              <input type="text" class="form-control" id="rua" name="rua" placeholder="Ex: Rua Sábia 179">
            </div>
            <div class="form-group col-6">
              <label for="bairro"><strong>Bairro</strong></label>
              <input type="text" class="form-control" id="bairro" name="bairro" placeholder="Ex: Garcia">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-6">
          ...
          <?php if (empty($disabled)) { ?>
            <button type="submit" class="btn btn-dark col-md-12" name="btnCadastrar"><i class="far fa-check-circle"></i></button>
          <?php } ?>
        </form>
      </div>
    </div>
