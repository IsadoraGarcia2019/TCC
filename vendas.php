			...
			<table class="table table-borderless table-dark col-md-10 offset-md-1 mt-5">
				<thead>
					<tr>
						...
						<th scope="col"><div><a class="btn btn-primary col-md-12 mt-3" href="edicaoVendas.php?id=<?=$item['id']?>">Editar Cardápio</a></div>
</th>
				...
				<tbody>
					<tr>
						<td class="card-title text-danger"><?=utf8_encode($item['id_usuario'])?></td>
     					<td>19/09/2019</td>
