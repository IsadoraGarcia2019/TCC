<center>
  <div class="redes-sociais" style="background-color: #de2828;">
    <div class="container" style="margin-top: 65px;">
      ...
      <a href="https://mail.google.com/mail/u/0/#inbox?compose=DmwnWsTJtrnhxXwfpDgvhvzGsLRlLgjHgjcfzcQFCTNqvbqkMSDXnPTwMNHPSkbjVnnrBWWPBfJq"><img src="media/images/email.png" alt="email" title="email" class="icones"></a>

      <img src="media/images/facebook.png" alt="facebook" title="facebook" class="icones">
