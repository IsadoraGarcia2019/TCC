	...
	<div class="row">
		<div class="col-10 col-md-6 mt-5 offset-md-3 offset-1" style="margin-top: -30px !important;">
			<div class="card" style="margin-right: auto; margin-left: auto;">
				<div class="card-body" > 
					<h2 class="box">Sua compra foi realizada com sucesso!<img class="ml-2" src="media/images/sucesso.png" style="height: 40px; margin-left: 260px !important;"></h2>
					<a href="index.php" class="btn text-white mt-3 col-12 col-md-12" style="background-color: rgb(122, 192, 67);">Voltar para a página inicial</a>
				</div>
			</div>
		</div>
	</div>	
